...
def login():
    ...
    with sqlite3.connect('resister.db') as db:
         c = db.cursor()

        # Find user If there is any take proper action
         db = sqlite3.connect('resister.db')
         cursor = db.cursor()
...
bg_icon=ImageTk.PhotoImage(file="C:/Users/Chakor/OneDrive/Desktop/22SS136 Road Damage/Road Damage/Road Damage Detection/L.jpg")
user_icon=ImageTk.PhotoImage(file="C:/Users/Chakor/OneDrive/Desktop/22SS136 Road Damage/Road Damage/Road Damage Detection/l1.png")
pass_icon=ImageTk.PhotoImage(file="C:/Users/Chakor/OneDrive/Desktop/22SS136 Road Damage/Road Damage/Road Damage Detection/p1.jpg")
