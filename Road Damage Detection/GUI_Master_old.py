...
msg="Road Damage detected"
def sms_send():
    url="https://www.fast2sms.com/dev/bulk"
    params={
  
        "authorization":"rKmTfqI29gozxwlVBN6UpkQsM7hOH8SaeELjnGRy5cZuJDAv34J2Dcrenm9YKZsWNiSfQx3w7lFACdEo",
        "sender_id":"SMSINI",
        "message":msg,
        "language":"english",
        "route":"p",
        "numbers":"9623736957,9657298221"
    }
...
def test_model_proc(fn):
    ...
    if fn!="":
        ...
        return A
    img = open(fn)    
    myfile = open("C:/Users/Chakor/OneDrive/Desktop/22SS136 Road Damage/Road Damage/Road Damage Detection/testing")
    if img == myfile:
          print(myfile)
...
def openimage():
    ...
    global fn
    print(fn)
    fileName = askopenfilename(initialdir='C:/Users/Chakor/OneDrive/Desktop/22SS136 Road Damage/Road Damage/Road Damage Detection/testing', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
